...
const SWIPER_SCRIPT_SRC =
  "https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js";
const SWIPER_STYLE_HREF =
...
export default function ExploreFunctionalitiesSection() {
    ...
    <section className="py-6 md:py-10 px-4">
      <div className="max-w-[920px] mx-auto my-6 md:my-10 text-center p-4 md:p-5 rounded-xl shadow-lg bg-white dark:bg-[#1E1E1E] border border-gray-200 dark:border-gray-700">
        <h1 className="font-plus-jakarta-sans font-bold text-base md:text-lg mb-4 md:mb-5 text-[#111111] dark:text-white">
          Explore <span className="text-[#22C55E]">SOHUB Connect</span>{" "}
          Functionalities
        </h1>
            ...
            <div className="flex gap-4 md:gap-10 items-center mb-4 md:mb-8 flex-wrap justify-center">
              <div className="flex-1 min-w-[240px] sm:min-w-[280px] text-left">
                <h3 className="font-plus-jakarta-sans font-semibold text-sm md:text-lg mb-3 md:mb-4 text-[#111111] dark:text-white">
                  Deliver a professional calling experience with SOHUB Connect's
                  smart IVR — no hardware or setup hassle.
                </h3>
                <ul className="list-none p-0 m-0 text-xs md:text-sm leading-relaxed">
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                      ✔
                    </span>
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Custom Welcome Messages – Set your own audio recordings or
                      personalized greetings to welcome callers
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Interactive Voice Menus – Guide callers to the right
                      team with clear menu options
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Smart Call Transfers – Automatically route callers to the
                      right team or destination based on their needs
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Playback Audio Messages – Announce updates, business
                      hours, or other important information through audio
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Ring Group Integration – Forward calls using smart ring
                      strategies for the right team
                    </span>
                  </li>
                </ul>
                <p className="font-inter text-xs md:text-sm text-[#525252] dark:text-white dark:text-opacity-70 mt-3 md:mt-5">
                  Ensure fast, accurate, and professional responses—right from
                  the first ring.
                </p>
              </div>
                  ...
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <img
                        ...
                        onClick={() =>
                          openImagePreview("/images/website/call_flow.png", "Call Flow")
                        }
              ...
              <div className="flex-1 min-w-[240px] sm:min-w-[280px] text-left">
                ...
                <ul className="list-none p-0 m-0 text-xs md:text-sm leading-relaxed">
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Instant Setup – New phones are created quickly and ready
                      to use
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Personalized Phone Naming – Organize phones by employee
                      name, team, or department
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      One-Click Activation – Just save, and your new phone is
                      instantly activated!
                    </span>
                  </li>
                </ul>
                  ...
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <img
                        ...
                        className="cursor-zoom-in"
                        onClick={() =>
                          openImagePreview("/images/features/phones_new.png", "Phones")
                        }
                        style={{ width: "100%", display: "block" }}
                      />
                    </div>
        ...
        {activeTab === "unified-communications" && (
          <div className="border border-gray-200 dark:border-gray-700 rounded-b-xl p-4 md:p-8 bg-white dark:bg-[#1E1E1E]">
            <div className="flex gap-4 md:gap-10 items-center mb-4 md:mb-8 flex-wrap justify-center">
              <div className="flex-1 min-w-[240px] sm:min-w-[280px] text-left">
                <h3 className="font-plus-jakarta-sans font-semibold text-sm md:text-lg mb-3 md:mb-4 text-[#111111] dark:text-white">
                  Easily forward incoming calls to one or multiple agents using
                  smart ring strategies tailored to your business.
                </h3>
                <ul className="list-none p-0 m-0 text-xs md:text-sm leading-relaxed">
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Multiple Ring Strategies – Choose from Ring All,
                      Sequential, or Random ring patterns based on your team
                      structure
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Add Multiple Phones – Group multiple team members or
                      departments under one ring group
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Flexible Call Distribution – Ensure no call goes
                      unanswered by distributing calls intelligently across your
                      team
                    </span>
                  </li>
                </ul>
                  ...
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <img
                        ...
                        className="cursor-zoom-in"
                        onClick={() =>
                          openImagePreview("/images/features/ring_group_new.png", "Ring Groups")
                        }
                        style={{ width: "100%", display: "block" }}
                      />
                    </div>
        ...
        {activeTab === "sound-file" && (
          <div className="border border-gray-200 dark:border-gray-700 rounded-b-xl p-4 md:p-8 bg-white dark:bg-[#1E1E1E]">
            <div className="flex gap-4 md:gap-10 items-center mb-4 md:mb-8 flex-wrap justify-center">
              <div className="flex-1 min-w-[240px] sm:min-w-[280px] text-left">
                <h3 className="font-plus-jakarta-sans font-semibold text-sm md:text-lg mb-3 md:mb-4 text-[#111111] dark:text-white">
                  Record Your Own Voice for Call Flows to Boost Customer
                  Satisfaction
                </h3>
                <ul className="list-none p-0 m-0 text-xs md:text-sm leading-relaxed">
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Record Your Own Voice – Create and upload custom welcome
                      messages, menu prompts, or announcements for your callers
                    </span>
                  </li>
                  <li className="relative mb-2 md:mb-4 pl-6 md:pl-9 pr-1 md:pr-2.5 py-1">
                    <span className="absolute left-0 text-[#22C55E] font-bold">
                    ...
                    <span className="font-inter text-[#525252] dark:text-white dark:text-opacity-80">
                      Use Immediately After Upload – Your voice recording
                      becomes instantly available in the call flow as soon as
                      it's uploaded
                    </span>
                  </li>
                </ul>
                  ...
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <img
                        ...
                        className="cursor-zoom-in"
                        onClick={() =>
                          openImagePreview("/images/website/sound_file.png", "Custom Audio")
                        }
                        style={{ width: "100%", display: "block" }}
                      />
                    </div>
