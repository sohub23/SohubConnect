    ...
    <section className="w-full bg-white dark:bg-[#121212] py-8 sm:py-10 md:py-12 lg:py-16">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="text-center space-y-6 sm:space-y-8 max-w-5xl mx-auto">
          ...
          <p className="font-inter text-[#525252] dark:text-white dark:text-opacity-70 text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto px-2">
            Start the conversation the moment intent appears
          </p>

          {/* Sub-headline */}
          <p className="font-inter text-[#111111] dark:text-white text-xs sm:text-sm md:text-base lg:text-lg max-w-2xl mx-auto px-2">
