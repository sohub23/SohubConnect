...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-12 md:py-16 px-6 bg-[#FAFAFA] dark:bg-[#0A0A0A]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="font-plus-jakarta-sans font-bold text-[32px] sm:text-[40px] md:text-[48px] text-[#111111] dark:text-white mb-4 leading-tight">
            How it works
          </h2>
          <p className="font-inter text-base sm:text-lg text-[#525252] dark:text-white dark:text-opacity-70">
